    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 风险评价计划
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="评价方法" label="评价方法">
                </el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="140px">
                ...
                <el-form-item label="评价方法">
                    <el-input v-model="form.评价方法"></el-input>
                </el-form-item>
                <el-form-item label="所属管线">
                    <el-input v-model="form.所属管线"></el-input>
                </el-form-item>
                <el-form-item label="管段">
                    <el-input v-model="form.管段"></el-input>
                </el-form-item>
                <el-form-item label="计划开始时间">
                    <el-input v-model="form.计划开始时间"></el-input>
                </el-form-item>
                <el-form-item label="计划结束时间">
                    <el-input v-model="form.计划结束时间"></el-input>
                </el-form-item>
            </el-form>
        ...
        <el-dialog title="新增" :visible.sync="addVisible" width="30%">
            <el-form ref="form" :model="addForm" label-width="140px">
                ...
                <el-form-item label="评价方法">
                    <el-input v-model="addForm.评价方法"></el-input>
                </el-form-item>
                <el-form-item label="所属管线">
                    <el-input v-model="addForm.所属管线"></el-input>
                </el-form-item>
                <el-form-item label="管段">
                    <el-input v-model="addForm.管段"></el-input>
                </el-form-item>
                <el-form-item label="计划开始时间">
                    <el-input v-model="addForm.计划开始时间"></el-input>
                </el-form-item>
                <el-form-item label="计划结束时间">
                    <el-input v-model="addForm.计划结束时间"></el-input>
                </el-form-item>
            </el-form>
            <span slot="footer" class="dialog-footer">
...
<script>
    ...
    export default {
        ...
        methods: {
            // 获取 easy-mock 的模拟数据
            getData() {
                fetchData(process.env.BASE_URL + '/风险评价计划.json',this.query).then(res => {
                    console.log(res);
